...
var _MoveTheLibrary = _interopRequireDefault(__webpack_require__(/*! ./pages/mine/WarehouseManagement/MoveTheLibrary/MoveTheLibrary.vue */ 376));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _MoveTheLibrary_vue_vue_type_template_id_7aa11383_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MoveTheLibrary.vue?vue&type=template&id=7aa11383&scoped=true& */ 377);
/* harmony import */ var _MoveTheLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MoveTheLibrary.vue?vue&type=script&lang=js& */ 379);
...
/* harmony import */ var _MoveTheLibrary_vue_vue_type_style_index_0_id_7aa11383_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MoveTheLibrary.vue?vue&type=style&index=0&id=7aa11383&lang=scss&scoped=true& */ 381);
  ...
  methods: {
      ...
      then(function (res) {
        if (res.code == 1000) {
          if (_this7.list.length == 0) {
            ...
            var dataList = res.data.page_data.good_data;
    ...
    checkboxChange: function checkboxChange(e) {
      if (e.value) {
        ...
        this.goodDataList.push(this.list.map(function (v) {if (v.id == e.name) return v;})[0]);
      } else {
        var index = '';
        this.goodDataList.forEach(function (v, i) {
          if (v.id == e.name) {
            index = i;
          }
        });
        this.goodDataList.splice(index, 1);
        this.selectedList.forEach(function (v, i) {
          if (v == e.name) {
            index = i;
          }
        });
    ...
    // 全选
    checkedAll: function checkedAll() {var _this8 = this;
      this.selectedList = this.list.map(function (val) {
        val.checked = true;
        return val.id;
      });
      this.goodDataList = this.list.filter(function (v) {
